...
BEGIN
	...
	***********************************/
    ...
    /*********************************
 	#TRANSACCION:  'PM_CINGPARFA_SEL'
 	#DESCRIPCION:	listado de conceptos de gatos con partidas prespeustaria para combo FA
 	#AUTOR:		maylee.perez
 	#FECHA:		30-11-2021 19:49:23
	***********************************/

	elsif(p_transaccion='PM_CINGPARFA_SEL')then
			...
			*/
			...
			v_consulta:='select
                        ...
                        from param.tconcepto_ingas conig
                          ...
                          inner join cd.tcuenta_doc_det cdet on cdet.id_partida = cp.id_partida
                          inner join cd.tcuenta_doc cdoc on cdoc.id_cuenta_doc_fk = cdet.id_cuenta_doc

				        where  conig.estado_reg = ''activo''
                        and conig.sw_autorizacion::varchar LIKE ''%fondo_avance%''
                        and ';
	...
	/*********************************
 	#TRANSACCION:  'PM_CINGPARFA_CONT'
 	#DESCRIPCION:	Conteo de registros
 	#AUTOR:		maylee.perez
 	#FECHA:		30-11-2021 19:49:23
	***********************************/

	elsif(p_transaccion='PM_CINGPARFA_CONT')then
