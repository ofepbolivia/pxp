...
BEGIN
	...
	***********************************/
      ...
      /*********************************
 	#TRANSACCION:  'PM_PCTABANACT_SEL'
 	#DESCRIPCION:	Consulta de datos
 	#AUTOR:		admin
 	#FECHA:		25-02-2019 20:07:41
	***********************************/

	elsif(p_transaccion='PM_PCTABANACT_SEL')then
        ...
        /*********************************
 	#TRANSACCION:  'PM_PCTABANACT_CONT'
 	#DESCRIPCION:	Conteo de registros
 	#AUTOR:		admin
 	#FECHA:		25-02-2019 20:07:41
	***********************************/

	elsif(p_transaccion='PM_PCTABANACT_CONT')then
