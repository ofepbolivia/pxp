...
Ext.form.ComboRec = function (config) {
    ...
    if (config.sysorigen) {
        ...
        if (config.origen == 'PROVEEDOR') {
            ...
            configini = {
                ...
                store: new Ext.data.JsonStore({
                    ...
                    totalProperty: 'total',
                    fields: ['id_proveedor', 'desc_proveedor', 'codigo', 'nit', 'rotulo_comercial', 'lugar2', 'email', 'num_proveedor', 'condicion'],
                    // turn on remote sorting
                    remoteSort: true,
                    baseParams: Ext.apply({par_filtro: 'desc_proveedor#codigo#nit#rotulo_comercial#num_proveedor#condicion'}, config.baseParams)

                }),
                valueField: 'id_proveedor',
                displayField: 'desc_proveedor',
                tpl: '<tpl for="."><div class="x-combo-list-item"><p><b><font color="green"><b>{rotulo_comercial}</b></font></b></p><p><b>{desc_proveedor}</b></p><p>{codigo}</p><p>NIT:{nit}</p><p>Lugar:{lugar}</p><p>Email: {email}</p></div></tpl>',
        ...
        if (config.origen == 'EP') {
            ...
            configini = {
                ...
                renderer: function (value, p, record) {
                    return String.format('{0}', record.data['desc_ep']);
                }
            ...
            configini = {
                ...
                store: new Ext.data.JsonStore({
                    ...
                    fields: ['id_centro_costo', 'codigo_cc', 'codigo_uo', 'ep', 'gestion', 'nombre_uo',
                        ...
                        'nombre_actividad', 'movimiento_tipo_pres', 'categoria'],
                    // turn on remote sorting
                    remoteSort: true,
        ...
        // (may) listado combo en FONDOS EN AVANCE para listar las monedas de las internacionales
        else if (config.origen == 'MONEDALISTINTERFA') {
            configini = {
                tinit: false,
                ...
                emptyText: 'Moneda...',
                store: new Ext.data.JsonStore({
                    url: config.url ? config.url : '../../sis_parametros/control/Moneda/listarMonedaSegunEstacionInter',
                    id: 'id_moneda',
                    root: 'datos',
                    sortInfo: {
                        field: 'moneda',
        ...
        //
        //18-07-2019 (may )FONDO EN AVACE modificacion de lista solo mostrar obligaciones de pago segun la estacion
        else if (config.origen == 'DEPTOFA') {
            configini = {
                tinit: false,
                resizable: true,
                tasignacion: false,
                ...
                emptyText: 'Departamento...',
                store: new Ext.data.JsonStore({
                    url: config.url ? config.url : '../../sis_parametros/control/Depto/listarDeptoFiltradoXUsuarioFA',
                    id: 'id_depto',
                    root: 'datos',
                    sortInfo: {
                        field: 'deppto.nombre',
        ...
        //checkout
        else if (config.origen == 'FUNCIONARIOCARX') {
            ...
            configini = {
                ...
                pid: this.idContenedor,
                store: new Ext.data.JsonStore({
                    url: config.url ? config.url : '../../sis_organigrama/control/Funcionario/listarFuncionarioCargoX',
                    id: 'id_uo',
                    root: 'datos',
                    sortInfo: {
                        field: 'desc_funcionario1',
                    ...
                    // turn on remote sorting
                    remoteSort: true,
                    baseParams: Ext.apply({par_filtro: 'desc_funcionario1'}, config.baseParams)
        ...
        //
        //18-07-2019 (may) persona campos aumentados
        else if (config.origen == 'PERSONAV2') {
            ...
            configini = {
                ...
                emptyText: 'Persona...',
                store: new Ext.data.JsonStore({
                    url: config.url ? config.url : '../../sis_seguridad/control/Persona/listarPersonaV2',
                    id: 'id_persona',
                    root: 'datos',
                    sortInfo: {
                        field: 'nombre_completo1',
                    ...
                    fields: ['id_persona', 'nombre_completo1', 'ci', 'nombre', 'ap_paterno', 'ap_materno', 'correo', 'celular1', 'telefono1', 'telefono2', 'celular2', {
                        ...
                        type: 'date',
                        dateFormat: 'Y-m-d'
                    }, 'genero', 'direccion', 'fax', 'pag_web','observaciones'],
                    // turn on remote sorting
                    remoteSort: true,
                    baseParams: Ext.apply({par_filtro: 'p.nombre_completo1#p.ci'}, config.baseParams)
                }),
