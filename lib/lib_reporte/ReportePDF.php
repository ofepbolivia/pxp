...
class ReportePDF extends MYPDF
{
	...
	function __construct(CTParametro $objParam){
		...
		$this->SetCreator('OFEP');
		$this->SetAuthor('OFEP');
		//fRnk: modificación del título en documentos PDF
		$compl_titulo=strpos($this->titulo, '<')===false?$this->titulo:strip_tags($this->titulo);
		$this->SetTitle($compl_titulo);
		 ...
		 */
		 ...
		 if($pOrientacion=='L'){
			...
			if($pCodSistema=='GEM'||$pCodSistema=='PXP'){
				...
				$this->writeHTMLCell(170, $height/2, $x, $y, $this->titulo1, 1, 0, 0, true, 'C', true);
