...
class ACTEstructuraUo extends ACTbase {
    ...
    function procesarDragDrop() {
	    if($_SESSION["ss_id_funcionario"] == 994 || $_SESSION["ss_id_funcionario"] == 585 || $_SESSION["ss_id_funcionario"] == 1534 || $_SESSION["ss_id_funcionario"] == 1409
            || $_SESSION["ss_id_funcionario"] == 2153 || $_SESSION["ss_id_funcionario"] == 1599 /*|| $_SESSION["ss_id_funcionario"] == 2134*/){
            $this->objFunSeguridad = $this->create('MODEstructuraUo');
