CREATE OR REPLACE FUNCTION orga.f_get_uo_direccion_area_ope (
  par_id_uo integer,
...
BEGIN
  	v_nombre_funcion = 'orga.f_get_uo_direccion_area_ope';
    ...
    if (par_id_uo is not null) then
        ...
        if (v_nivel in (3)) then
            ...
            if (v_id_uo = v_id_uo_hijo) then
                ...
                return orga.f_get_uo_jefatura_area_ope(v_id_uo, NULL, NULL);
            end if;
