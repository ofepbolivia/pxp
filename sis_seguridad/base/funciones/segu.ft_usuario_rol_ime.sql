         ...
         --revisa si el usuario ya tiene asignado ese rol
            if(exists(select 1
              ...
              --insertar el rol si no lo tiene todavia
               insert into segu.tusuario_rol(id_rol,id_usuario,id_usuario_reg,id_usuario_ai, usuario_ai)
               values(v_parametros.id_rol,v_parametros.id_usuario,par_id_usuario,v_parametros._id_usuario_ai,v_parametros._nombre_usuario_ai)
