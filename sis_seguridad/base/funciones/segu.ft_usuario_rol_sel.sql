     ...
     if(par_transaccion='SEG_USUROL_SEL')then
          ...
          BEGIN
               ...
               v_consulta:='SELECT
                                ...
                                usurol.fecha_mod,
                                usurol.fecha_reg_hora
                             FROM segu.tusuario_rol usurol
                             LEFT JOIN segu.tusuario usu1 on usu1.id_usuario = usurol.id_usuario_reg
                             LEFT JOIN segu.tusuario usu2 on usu2.id_usuario = usurol.id_usuario_mod
