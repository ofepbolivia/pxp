	...
	***********************************/
    ...
    insert into segu.tusuario_externo(
            ...
            select 	v_parametros.id_usuario,
					lpad(COALESCE(nextval('segu.tusu_externo_amadeus'::regclass), 0)::varchar,4,'0')||substring(lower(v_arreglo[1]::varchar) from 1 for 1)||substring (lower(v_apellido) from 1 for 1)::varchar,
                    'activo',
                    'Amadeus'::varchar,
                    now(),
                    v_parametros._nombre_usuario_ai,
