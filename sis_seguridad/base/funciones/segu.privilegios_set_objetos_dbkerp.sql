...
BEGIN
	esquemas = string_to_array('adq,af,alm,banc,bucardo,cd,cola,conta,cos,cvpn,decr,firmdig,gecom,gen,informix,
	...
	FOREACH esquema in ARRAY esquemas LOOP
   		...
   		LOOP
      	RAISE NOTICE 'Asignando todos los privilegios a % sobre %.%', p_user, esquema, objeto;
    	...
    	EXECUTE 'GRANT CREATE, USAGE ON SCHEMA '||esquema||' TO '|| v_usuario ;
   	END LOOP;
