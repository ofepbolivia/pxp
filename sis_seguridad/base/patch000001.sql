...
/*****************************I-SCP-BVP-SEGU-0-22/03/2021*************/
ALTER TABLE segu.tusuario
  ADD COLUMN fecha_reg_hora TIMESTAMP WITHOUT TIME ZONE;

ALTER TABLE segu.tusuario
  ALTER COLUMN fecha_reg_hora SET DEFAULT now();

COMMENT ON COLUMN segu.tusuario.fecha_reg_hora
IS 'fecha registro completa con hora-minuto-segundo';

ALTER TABLE segu.tusuario
  ADD COLUMN id_usuario_reg INTEGER;

ALTER TABLE segu.tusuario
  ADD COLUMN id_usuario_mod INTEGER;

ALTER TABLE segu.tusuario
  ADD COLUMN fecha_mod TIMESTAMP WITHOUT TIME ZONE;
...
COMMENT ON COLUMN segu.tusuario.observaciones
IS 'Descripcion o observacion de usuario registrado.';

ALTER TABLE segu.tusuario_rol
  ADD COLUMN fecha_reg_hora TIMESTAMP WITHOUT TIME ZONE;

ALTER TABLE segu.tusuario_rol
  ALTER COLUMN fecha_reg_hora SET DEFAULT now();

COMMENT ON COLUMN segu.tusuario_rol.fecha_reg_hora
IS 'fecha registro completa con hora-minuto-segundo';
...
COMMENT ON COLUMN segu.trol.fecha_reg_hora
IS 'fecha registro completa con hora-minuto-segundo';
