CREATE OR REPLACE FUNCTION wf.f_gant_wf_recursiva_grilla (
...
BEGIN
    ...
    v_nombre_funcion = 'wf.f_gant_wf_recursiva_grilla';
       ...
       INSERT INTO
         ...
         FOR  v_registros in (
                ...
                IF not ( wf.f_gant_wf_recursiva_grilla(v_registros.id_proceso_wf, v_registros.id_estado_wf_prev ,p_id_usuario, v_id_proceso, v_id_anterior)) THEN
...
ALTER FUNCTION wf.f_gant_wf_recursiva_grilla (p_id_proceso_wf integer, p_id_estado_wf integer, p_id_usuario integer, p_id_padre integer, p_id_anterior integer)
  OWNER TO postgres;
