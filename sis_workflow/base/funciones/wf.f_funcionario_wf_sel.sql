    ...
    elseif v_tipo_asignacion = 'segun_depto' then
     ...
     elseif v_tipo_asignacion = 'funcion_listado' then
      ...
      IF v_nombre_func_list ='ADQ_RPC_SOL_COMPRA'  THEN
       ...
       /*
       (may) 04/11/2020
       funcion para verificar el funcionario aprobador
       */
       ELSEIF v_nombre_func_list ='ADQ_FUN_APROBADOR'  THEN

                 IF p_count=FALSE then

                      --recuperamos el funcionario supervisor de la solicitud de COMPRA
                      v_consulta='select
                                          fun.id_funcionario,
                                          fun.desc_funcionario1 as desc_funcionario,
       ...
       */
       ELSEIF v_nombre_func_list ='INTE_FUN_GM_OP'  THEN
